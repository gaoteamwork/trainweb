		...
		<div  class="container">
			<div class="row" align = "center">
				<div class="col-xs-12 col-md-4">
					<a href ="ser1.php"><i class="glyphicon glyphicon-globe"></i></a>
				...
				<div class="col-xs-12 col-md-4">
					<a href ="ser2.php"><i class="glyphicon glyphicon-transfer"></i></a>
				...
				<div class="col-xs-12 col-md-4">
					<a href ="ser3.php"><i class="glyphicon glyphicon-phone-alt"></i></a>
				...
				<div class="col-xs-12 col-md-4">
					<a href ="ser4.php"><i class="glyphicon glyphicon-th-large"></i></a>
				...
				<div class="col-xs-12 col-md-4">
					<a href ="ser5.php"><i class="glyphicon glyphicon-earphone"></i></a>
				...
				<div class="col-xs-12 col-md-4">
					<a href ="ser6.php"><i class="glyphicon glyphicon-import"></i></a>
				...
				<div class="col-xs-12 col-md-4">
					<a href ="ser7.php"><i class="glyphicon glyphicon-hd-video"></i></a>
				...
				<div class="col-xs-12 col-md-4">
					<a href ="ser8.php"><i class="glyphicon glyphicon-signal"></i></a>
				...
				<div class="col-xs-12 col-md-4">
					<a href ="ser9.php"><i class="glyphicon glyphicon-export"></i></a>
				...
				<div class="col-xs-12 col-md-4">
					<a href ="ser10.php"><i class="glyphicon glyphicon-eye-open"></i></a>
